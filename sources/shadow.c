...
static int triangle_shadow(t_data *data, int i, t_ray ray)
{
	...
	while (y >= 0)
		{
		if ((int)data->obj[y].num_polygonals > i && intersecttriangle(shadow_ray(&data->hit.t, data->hit, ray, "model"), data, y, i) == 1)
		{
